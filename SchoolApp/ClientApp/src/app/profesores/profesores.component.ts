...
export class ProfesorComponent implements OnInit, AfterViewInit {
  ...
  entidades: Profesor[] = [];
  entidadSeleccionada: Profesor = this.inicializarEntidad();
  isEditing: boolean = false;
  filtro: string = '';
  page: number = 1;
  constructor(private Service: ProfesorService) { }
  entidadesFiltradas(): Profesor[] {
  ...
  seleccionarEntidad(entidad: Profesor): void {
  ...
  private inicializarEntidad(): Profesor {
    return {
      id: 0,
      nombres: '',
      apellidos: '',
