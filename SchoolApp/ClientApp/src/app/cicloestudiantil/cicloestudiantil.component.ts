...
@Component({
  selector: 'app-cicloestudiantil',
  templateUrl: './cicloestudiantil.component.html',
  styleUrls: ['./cicloestudiantil.component.css']
})
export class CicloEstudiantilComponent implements OnInit, AfterViewInit {
  ...
  filtro: string = '';
  page: number = 1;
  constructor(private Service: CicloEstudiantilService) { }
